        ...
        <div class="app-main">
            ...
            >
                ...
                <div
                    ...
                    class="fixed bottom-20 lg:bottom-8 left-1/2 lg:left-auto lg:right-8 -translate-x-1/2 lg:translate-x-0 z-[90] w-[calc(100%-2.5rem)] max-w-sm"
                >
                ...
                >
                    ...
                    <div
                        ...
                        x-transition:enter-start="opacity-0 translate-y-full lg:translate-y-4"
                        x-transition:enter-end="opacity-100 translate-y-0"
                        x-transition:leave="transition ease-in duration-300"
                        x-transition:leave-start="opacity-100 translate-y-0"
                        x-transition:leave-end="opacity-0 translate-y-full lg:translate-y-4"
                        class="relative w-full max-w-md bg-white rounded-t-3xl lg:rounded-3xl px-6 pt-5 pb-10 shadow-2xl"
                    >
                        {{-- Handle --}}
                        <div class="w-10 h-1 bg-gray-200 rounded-full mx-auto mb-5 lg:hidden"></div>
            ...
            {{-- Flash Messages --}}
                @if(session('success'))
                    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3500)"
                         ...
                         class="fixed top-4 left-1/2 lg:left-auto lg:right-8 -translate-x-1/2 lg:translate-x-0 z-50 w-[calc(100%-2rem)] max-w-sm">
                ...
                {{-- Page Content --}}
                <main class="flex-1 overflow-y-auto pb-20 lg:pb-8 scrollbar-hide pt-safe">
                    {{ $slot }}
                </main>
