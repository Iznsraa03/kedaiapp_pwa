<x-app-layout>
    ...
    {{-- Header --}}
    <div class="bg-[#2563EB] px-5 pt-12 pb-6 rounded-b-3xl">
    ...
    <div class="px-5 py-5 space-y-3">
        ...
        <div class="bg-white border border-gray-100 rounded-3xl p-4 flex items-center gap-4 shadow-sm active:scale-[0.98] transition-transform duration-150">
            <div class="w-16 h-16 bg-[#EFF6FF] rounded-2xl flex items-center justify-center text-3xl flex-shrink-0">
                {{ $item['emoji'] }}
            </div>
            <div class="flex-1">
                <p class="text-[#1E3A8A] font-semibold text-sm">{{ $item['nama'] }}</p>
            ...
            <div class="flex flex-col items-end gap-2">
                <button class="text-red-400 active:scale-90 transition-transform">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                    </svg>
                </button>
                <p class="text-[#2563EB] font-bold text-sm">{{ $item['harga'] }}</p>
            </div>
        </div>
        @endforeach
