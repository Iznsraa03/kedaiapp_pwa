<x-app-layout>
    <div class="max-w-md mx-auto min-h-screen bg-white">
        <div class="bg-[#2563EB] px-5 pt-8 pb-4 relative overflow-hidden rounded-b-[2rem]">
            ...
            <h1 class="text-white text-2xl font-extrabold tracking-tight">Berita</h1>
            <p class="text-blue-200 text-sm mt-0.5">Semua update terbaru dari kami</p>
        </div>

        <div class="px-5 py-6 space-y-4">
            @forelse($news as $item)
                <a href="#" class="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm active:scale-[0.98] transition-transform duration-150 flex flex-col">
                    @if($item->image_url)
