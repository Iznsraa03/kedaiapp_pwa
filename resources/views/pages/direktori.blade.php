<x-app-layout>
    ...
    <div class="bg-[#2563EB] px-5 pt-12 pb-6 relative overflow-hidden rounded-b-[2rem]">
        ...
        <div class="relative z-10 mt-4">
            <input
                ...
                class="w-full bg-white/20 backdrop-blur-sm text-white placeholder:text-blue-200 text-sm font-medium px-4 py-3 pl-10 rounded-2xl border border-white/20 focus:outline-none focus:bg-white/30 transition-all duration-200"
            >
            <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-blue-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="px-5 py-4 space-y-3" id="member-list">
        ...
        <div
            class="member-card bg-white border border-gray-100 rounded-2xl p-4 shadow-sm flex items-center gap-3"
        ...
        >
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                ...
                <a href="https://wa.me/{{ $waNumber }}"
                   ...
                   class="w-10 h-10 bg-green-50 rounded-xl flex items-center justify-center active:scale-90 transition-transform duration-150"
                ...
                <a href="mailto:{{ $member->email }}"
                   class="w-10 h-10 bg-[#EFF6FF] rounded-xl flex items-center justify-center active:scale-90 transition-transform duration-150"
