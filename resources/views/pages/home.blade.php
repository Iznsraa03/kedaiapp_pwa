<x-app-layout>
    ...
    <div class="px-5 mt-4 mb-1">
        <a href="{{ route('profil') }}"
           class="flex items-center gap-3 bg-white border border-gray-100 shadow-md active:scale-[0.98] hover:shadow-lg transition-all duration-150 w-full px-4 py-3"
